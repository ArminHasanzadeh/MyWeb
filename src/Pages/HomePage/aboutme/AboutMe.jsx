 ...
 <>
    <section className="w-full h-auto mt-20 flex justify-center items-center flex-col  xl:visible ">
          <div className="w-[70%] flex justify-start items-center ">
            ...
            <h4 className="text-white text-4xl w-[15%] max-sm:w-[100%] max-md:w-[25%]  text-start">about-me</h4>
          ...
          <div className="About-Me w-[60%] max-sm:w-full h-auto flex justify-center items-center text-1xl max-sm:flex-col ">
            <div className="w-[50%] max-sm:w-[80%]">
              ...
              <Link to="/Content"><button className="flex p-2 "> Read more <span className="ml-2"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#ABB2BF"><path d="M647-440H160v-80h487L423-744l57-56 320 320-320 320-57-56 224-224Z"/></svg></span></button></Link>
            </div>
