...
function Contacts() {
    ...
    <>
        <section className="w-full h-auto mt-20 flex justify-center items-center flex-col xl:visible ">
             ...
             <section className="w-full h-auto  flex justify-center items-center flex-col xl:visible ">
            
             <div className='w-[60%] flex justify-center items-center max-sm:flex-col'>
             ...
             <div className='w-[70%] flex justify-center items-end  Contacts-Me flex-col max-xl:w-full  max-xl:items-center '>
