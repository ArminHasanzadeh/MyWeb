        ...
        <>  
            ...
            <section>
                <h1 className="w-[50%] h-auto flex justify-center items-center text-5xl text-white max-xl:mt-10">
                    <mark className=" bg-transparent text-[var(--FontTextcherColor)]">/</mark>
                    Project
                </h1>
                <p className="w-[50%] flex justify-center items-center text-[var(--FontTextColor)] max-xl:flex-col">List of my Project</p>
